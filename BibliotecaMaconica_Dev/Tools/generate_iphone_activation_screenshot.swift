...
drawCentered("Biblioteca Maçônica", y: 630, size: 68, weight: .bold, fill: .white)
...
drawCentered("Biblioteca Maçônica", y: 2480, size: 34, weight: .bold, fill: color(235, 194, 92))
