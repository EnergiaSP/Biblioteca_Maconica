...
func drawPhoneHome(_ c: Canvas) {
    ...
    c.text("Biblioteca Maçônica", x: 98, top: 790, size: 42, weight: .bold, fill: .white)
    c.text("Leituras, estudos e obras maçônicas em um só lugar.", x: 98, top: 858, size: 30, fill: color(196, 203, 208))
...
func drawPadHome(_ c: Canvas) {
    ...
    c.text("Biblioteca Maçônica", x: 190, top: 770, size: 48, weight: .bold, fill: .white)
    c.text("Leituras, estudos e obras maçônicas em um só lugar.", x: 190, top: 845, size: 32, fill: color(196, 203, 208))
...
func drawWatch(_ c: Canvas, mode: Kind) {
    ...
    c.text(mode == .resumoWatch ? "Resumo no Watch" : "Biblioteca Maçônica", x: 58, top: 246, size: 22, weight: .bold, fill: .white)
