...
drawCentered("Biblioteca Maçônica", y: 594, size: 78, weight: .bold, fill: .white)
...
drawCentered("Biblioteca Maçônica", y: 2450, size: 34, weight: .bold, fill: color(235, 194, 92))
